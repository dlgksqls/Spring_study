...
public class CertificationServiceImplTest {
    ...
    public void 이메일과_컨텐츠가_제대로_만들어져서_보내지는지_테스트한다(){
        ...
        // when
        certificationServiceImpl.send("testemail393939@gmail.com", 1, "aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa");

        // then
        assertThat(fakeMailSender.email).isEqualTo("testemail393939@gmail.com");
